...
static const char * const spicc_sclk_parent_names[] = {
	IN_PREFIX "xtal", "clk81", "fclk_div4", "fclk_div3", "fclk_div5",
	"fclk_div7",
};
...
static struct clk_regmap g12a_spicc0_sclk_sel = {
	...
	.hw.init = &(struct clk_init_data){
		...
		.ops = &clk_regmap_mux_ops,
		.parent_names = spicc_sclk_parent_names,
		.num_parents = ARRAY_SIZE(spicc_sclk_parent_names),
	},
};
...
static struct clk_regmap g12a_spicc0_sclk_div = {
	...
	.hw.init = &(struct clk_init_data){
		...
		.ops = &clk_regmap_divider_ops,
		.parent_names = (const char *[]){ "spicc0_sclk_sel" },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static struct clk_regmap g12a_spicc0_sclk = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "spicc0_sclk",
		.ops = &clk_regmap_gate_ops,
		.parent_names = (const char *[]){ "spicc0_sclk_div" },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static struct clk_regmap g12a_spicc1_sclk_div = {
	...
	.hw.init = &(struct clk_init_data){
		...
		.ops = &clk_regmap_divider_ops,
		.parent_names = (const char *[]){ "spicc1_sclk_sel" },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static struct clk_regmap g12a_spicc1_sclk = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "spicc1_sclk",
		.ops = &clk_regmap_gate_ops,
		.parent_names = (const char *[]){ "spicc1_sclk_div" },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static const char * const nna_clk_parent_names[] = {
	IN_PREFIX "xtal", "gp0_pll", "hifi_pll", "fclk_div2p5", "fclk_div3",
	"fclk_div4", "fclk_div5", "fclk_div7",
};

static struct clk_regmap sm1_nna_axi_clk_sel = {
	.data = &(struct clk_regmap_mux_data){
		.offset = HHI_NN_CLK_CNTL,
		.mask = 7,
		.shift = 9,
	},
	.hw.init = &(struct clk_init_data){
		...
		.ops = &clk_regmap_mux_ops,
		.parent_names = nna_clk_parent_names,
		.num_parents = ARRAY_SIZE(nna_clk_parent_names),
	},
};
...
static struct clk_regmap sm1_nna_axi_clk_div = {
	...
	.hw.init = &(struct clk_init_data){
		...
		.ops = &clk_regmap_divider_ops,
		.parent_names = (const char *[]){ "nna_axi_clk_sel" },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static struct clk_regmap sm1_nna_axi_clk = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "nna_axi_clk",
		.ops = &clk_regmap_gate_ops,
		.parent_names = (const char *[]){ "nna_axi_clk_div" },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static struct clk_regmap sm1_nna_core_clk_div = {
	...
	.hw.init = &(struct clk_init_data){
		...
		.ops = &clk_regmap_divider_ops,
		.parent_names = (const char *[]){ "nna_core_clk_sel" },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static struct clk_regmap sm1_nna_core_clk = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "nna_core_clk",
		.ops = &clk_regmap_gate_ops,
		.parent_names = (const char *[]){ "nna_core_clk_div" },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
	},
};
